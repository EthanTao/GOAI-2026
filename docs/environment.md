...
> 环境快照
> **当前执行机（2026-08-14）**：云主机 Ubuntu 22.04、**RTX 4090 24GB**、仅 `/dev/vda1` → `/`（约 97G 总 / 82G 剩余）。**没有数据盘。** 驱动曾为 525.105.17（官方 RoboDojo 要 570/580）。
> 下文「OS / GPU / 磁盘」表格是 **笔记本 2026-08-13 历史快照**，不要当成这台 4090 的现状。
> 磁盘数字以 `df -h` 实际为准。
